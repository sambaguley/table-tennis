...
},{"./_baseClone":"s7WH"}],"qbLA":[function(require,module,exports) {
"use strict";var e;Object.defineProperty(exports,"__esModule",{value:!0}),exports.VERSION_NUMBER=exports.PHASE=exports.INPUT=exports.COLOURS=exports.WIN_SCORE=exports.BAT_WIDTH=exports.BAT_HEIGHT=exports.BALL_RADIUS=exports.BAT_SIDE_MARGIN=exports.GAME_HEIGHT=exports.GAME_WIDTH=exports.BAT_SIDE=void 0,function(e){e.left="LEFT",e.right="RIGHT"}(e=exports.BAT_SIDE||(exports.BAT_SIDE={})),exports.GAME_WIDTH=600,exports.GAME_HEIGHT=400,exports.BAT_SIDE_MARGIN=20,exports.BALL_RADIUS=10,exports.BAT_HEIGHT=60,exports.BAT_WIDTH=8,exports.WIN_SCORE=11,exports.COLOURS={BACKGROUND:"#333",MAIN:"#CCC"},exports.INPUT={UP:"q",DOWN:"a"},exports.PHASE={START:"START",GAME:"GAME",END:"END"},exports.VERSION_NUMBER="1.3";
},{}],"DkAX":[function(require,module,exports) {
"use strict";var e=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0});var t,l,a,n,i=e(require("lodash/cloneDeep")),s=require("./gameConstants"),d=function(e,t){var l=e*Math.cos(t);return[e*Math.sin(t),l]},b=function(){return 4+1*Math.random()},o={x:s.GAME_WIDTH/2-5,y:s.GAME_HEIGHT/2,width:10,height:10,speed:6,acceleration:.2,maxSpeed:8,angle:b(),dx:0,dy:0},r={x:s.BAT_SIDE_MARGIN,y:s.GAME_HEIGHT/2,speed:6},f={x:s.GAME_WIDTH-s.BAT_SIDE_MARGIN,y:s.GAME_HEIGHT/2,speed:3},c=function(){var e=b();return n=new Audio("./blip.wav"),{phase:s.PHASE.START,ball:{x:o.x,y:s.GAME_HEIGHT/2,width:o.width,height:o.height,speed:o.speed,acceleration:o.acceleration,maxSpeed:o.maxSpeed,angle:e,paused:!1,dy:0,dx:0},batLeft:{x:r.x,y:r.y,speed:0,upPressed:!1,downPressed:!1},batRight:{x:f.x,y:f.y,direction:null,speed:0},score:{player1:0,player2:0}}},E=i.default(c()),u=function(){a.clearRect(0,0,s.GAME_WIDTH,s.GAME_HEIGHT)},T=function(){n.play()},y=function(){a.strokeStyle=s.COLOURS.MAIN,a.setLineDash([10,10]),a.beginPath(),a.moveTo(s.GAME_WIDTH/2,0),a.lineTo(s.GAME_WIDTH/2,s.GAME_HEIGHT),a.stroke()},A=function(){a.strokeStyle="white",a.font="60px arial",a.textAlign="right",a.fillText(E.score.player1,s.GAME_WIDTH/2-20,60),a.textAlign="left",a.fillText(E.score.player2,s.GAME_WIDTH/2+20,60)},p=function(){a.fillStyle="white",a.font="30px arial",a.textAlign="left",a.fillText("AMAZING TABLE TENNIS GAME",60,80)},H=function(){a.fillStyle="white",a.font="12px arial",a.textAlign="left",a.fillText("Version: "+s.VERSION_NUMBER,5,15)},I=function(){a.fillStyle=s.COLOURS.MAIN,a.fillRect(E.ball.x,E.ball.y,E.ball.width,E.ball.height),a.fill()},h=function(e){a.fillStyle=s.COLOURS.MAIN,e===s.BAT_SIDE.left?a.fillRect(E.batLeft.x,E.batLeft.y,s.BAT_WIDTH,s.BAT_HEIGHT):a.fillRect(E.batRight.x,E.batRight.y,s.BAT_WIDTH,s.BAT_HEIGHT)},G=function(){E.ball.paused=!1,E.ball.x=o.x,E.ball.y=s.GAME_HEIGHT/2,E.ball.angle=b()},g=function(){E.score.player1>=s.WIN_SCORE?(w(),F(),E.phase=s.PHASE.END,K.innerHTML="YOU WIN!!!"):E.score.player2>=s.WIN_SCORE&&(w(),F(),E.phase=s.PHASE.END,K.innerHTML="YOU LOSE!!!")},x=function(){return.5*Math.random()-.25},_=function(){E.phase==s.PHASE.GAME&&((E.ball.x<0||E.ball.x>s.GAME_WIDTH)&&(E.ball.x<0&&!E.ball.paused&&(E.ball.speed<E.ball.maxSpeed&&(E.ball.speed=E.ball.speed+E.ball.acceleration),E.score.player2+=1,E.ball.paused=!0,T(),R(1e3,G)),E.ball.x>s.GAME_WIDTH&&!E.ball.paused&&(E.ball.speed<E.ball.maxSpeed&&(E.ball.speed=E.ball.speed+E.ball.acceleration),E.score.player1+=1,E.ball.paused=!0,T(),R(1e3,G)),console.log("speed: ",E.ball.speed)),(E.ball.y>s.GAME_HEIGHT-10||E.ball.y<10)&&(T(),E.ball.angle=E.ball.angle+Math.PI/2),E.ball.x<E.batLeft.x+s.BAT_WIDTH&&E.ball.x>E.batLeft.x&&E.ball.y<E.batLeft.y+s.BAT_HEIGHT&&E.ball.y>E.batLeft.y&&(T(),E.ball.angle=E.ball.angle+Math.PI+x()),E.ball.x<E.batRight.x+s.BAT_WIDTH&&E.ball.x>E.batRight.x&&E.ball.y<E.batRight.y+s.BAT_HEIGHT&&E.ball.y>E.batRight.y&&(T(),E.ball.angle=E.ball.angle+Math.PI+x()),E.ball.dx>0&&E.ball.dy<0&&E.batRight.y>E.ball.y?E.batRight.speed=-f.speed:E.ball.dx>0&&E.ball.dy>0&&E.batRight.y<E.ball.y&&(E.batRight.speed=f.speed),g())},M=function(){E=i.default(c())},L=function(){a.fillStyle=s.COLOURS.BACKGROUND,a.fillRect(0,0,s.GAME_WIDTH,s.GAME_HEIGHT)},R=function(e,t){setTimeout(function(){t()},e)},m=function(){if(E.phase==s.PHASE.GAME){var e=d(E.ball.speed,E.ball.angle),t=e[0],l=e[1];E.ball.dx=t,E.ball.dy=l,E.ball.x=E.ball.x+t,E.ball.y=E.ball.y+l,s.BAT_HEIGHT+E.batLeft.y>s.GAME_HEIGHT?E.batLeft.y=s.GAME_HEIGHT-s.BAT_HEIGHT:E.batLeft.y<0?E.batLeft.y=0:E.batLeft.y=E.batLeft.y+E.batLeft.speed,s.BAT_HEIGHT+E.batRight.y>s.GAME_HEIGHT?E.batRight.y=s.GAME_HEIGHT-s.BAT_HEIGHT:E.batRight.y<0?E.batRight.y=0:E.batRight.y=E.batRight.y+E.batRight.speed,E.batRight.y=E.batRight.y+E.batRight.speed}},S=function(e,t){"LEFT"===e&&("DOWN"===t?E.batLeft.speed=r.speed:"UP"===t&&(E.batLeft.speed=-r.speed))},P=function(e){var t=e.key;t===s.INPUT.DOWN?E.batLeft.downPressed=!1:t===s.INPUT.UP&&(E.batLeft.upPressed=!1),E.batLeft.upPressed||E.batLeft.downPressed||(E.batLeft.speed=0)},D=function(){u(),L(),p()},B=function(){u(),L(),y(),I(),h(s.BAT_SIDE.left),h(s.BAT_SIDE.right),A(),H()},N=function e(){m(),B(),_(),t=requestAnimationFrame(e)},W=function(){l=document.getElementById("game"),a=l.getContext("2d"),D(),E.phase=s.PHASE.GAME,t||O()},O=function(){t=requestAnimationFrame(N)},w=function(){M(),cancelAnimationFrame(t)},v=function(e){var t=e.key;E.phase==s.PHASE.GAME&&(t===s.INPUT.UP?(S("LEFT","UP"),E.batLeft.upPressed=!0):t===s.INPUT.DOWN?(S("LEFT","DOWN"),E.batLeft.downPressed=!0):"p"===t?(S("RIGHT","UP"),E.batRight.downPressed=!0):"l"===t&&(S("RIGHT","DOWN"),E.batRight.downPressed=!0))};document.addEventListener("keydown",function(e){v(e)}),document.addEventListener("keyup",function(e){P(e)});var U=function(){Y.classList.add("hide")},C=function(){Y.classList.remove("hide")},k=function(){j.classList.add("hide")},F=function(){j.classList.remove("hide")},q=document.getElementsByClassName("startButton")[0],V=document.getElementsByClassName("restartButton")[0],Y=document.getElementById("startScreen"),j=document.getElementById("endScreen"),K=document.getElementById("resultText");q.addEventListener("mousedown",function(e){W(),U()}),V.addEventListener("mousedown",function(e){W(),k()});
},{"lodash/cloneDeep":"Y0zI","./gameConstants":"qbLA"}]},{},["DkAX"], null)
//# sourceMappingURL=gameControl.e6f7ce0c.js.map